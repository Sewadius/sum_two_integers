## Sum for two integers

<img src="img/splash.png" style="height:130px">

**The program counts the sum for two integers:**      
...
**New future features**
- mode for multiply input and saving it in the list
